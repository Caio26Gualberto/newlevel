...
namespace NewLevel.Domain.Interfaces.Authenticate
{
    public interface IAuthenticateService
    {
        ...
        Task<(string, int, string)> RegisterUser(string email, string password, string nickname, EActivityLocation activityLocation);
        Task<(string, int, string)> BandRegister(string email, string password, string nickname, string description, DateTime createdAt, List<EMusicGenres> musicGenres, 
        ...
        // JWT Methods
        Task<string> GenerateJwtToken(string email, string avatar = "");
