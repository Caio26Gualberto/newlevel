 ...
 */
export function instanceOfProfileInfoDtoNewLevelResponse(value: object): value is ProfileInfoDtoNewLevelResponse {
    return true;
}
...
export function ProfileInfoDtoNewLevelResponseToJSON(json: any): ProfileInfoDtoNewLevelResponse {
    return ProfileInfoDtoNewLevelResponseToJSONTyped(json, false);
}

export function ProfileInfoDtoNewLevelResponseToJSONTyped(value?: ProfileInfoDtoNewLevelResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
