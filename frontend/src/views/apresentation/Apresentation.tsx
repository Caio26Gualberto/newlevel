...
const Apresentation = () => {
    return (
        <Box position="relative" height="100vh" overflow="hidden" bgcolor="#000">
            <Box position="relative" width="100%" height="100%">
                <Box component="img" position="absolute" width="100%" height="100%" sx={{ opacity: "0.5" }} src={CelticFrost} alt="Celtic Frost" />
                <Box position="absolute" top="50%" left="50%" color="white" textAlign="center" sx={{ transform: "translate(-50%, -50%)" }}>
                    <Typography>
