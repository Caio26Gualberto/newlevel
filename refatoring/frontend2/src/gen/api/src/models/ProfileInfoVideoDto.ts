 ...
 */
export function instanceOfProfileInfoVideoDto(value: object): value is ProfileInfoVideoDto {
    return true;
}
...
export function ProfileInfoVideoDtoToJSON(json: any): ProfileInfoVideoDto {
    return ProfileInfoVideoDtoToJSONTyped(json, false);
}

export function ProfileInfoVideoDtoToJSONTyped(value?: ProfileInfoVideoDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
