...
export function instanceOfEGitLabels(value: any): boolean {
    for (const key in EGitLabels) {
        if (Object.prototype.hasOwnProperty.call(EGitLabels, key)) {
            if (EGitLabels[key as keyof typeof EGitLabels] === value) {
                return true;
            }
        }
    }
...
export function EGitLabelsToJSONTyped(value: any, ignoreDiscriminator: boolean): EGitLabels {
    return value as EGitLabels;
}
