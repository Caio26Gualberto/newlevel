 ...
 */
export function instanceOfLoginResponseDtoNewLevelResponse(value: object): value is LoginResponseDtoNewLevelResponse {
    return true;
}
...
export function LoginResponseDtoNewLevelResponseToJSON(json: any): LoginResponseDtoNewLevelResponse {
    return LoginResponseDtoNewLevelResponseToJSONTyped(json, false);
}

export function LoginResponseDtoNewLevelResponseToJSONTyped(value?: LoginResponseDtoNewLevelResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
